...
fecha_inicio, (to_date(dia_liq || '/' || mes_liq || '/2023', 'dd/MM/yyyy')+cant_dias) fecha_fin FROM p5p2e5_fecha_liq)
         tabla WHERE to_date('10/1/2023','dd/MM/yyyy') BETWEEN tabla.fecha_inicio AND tabla.fecha_fin;
